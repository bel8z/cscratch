...
CIMGUI_API int igImAbsInt(int x);
...
CIMGUI_API float igImRsqrtFloat(float x);
CIMGUI_API double igImRsqrtdouble(double x);
...
CIMGUI_API void igTableGcCompactTransientBuffersTablePtr(ImGuiTable* table);
CIMGUI_API void igTableGcCompactTransientBuffersTableTempDataPtr(ImGuiTableTempData* table);
