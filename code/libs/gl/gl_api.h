...
CF_API bool glApiLoad(GlApiLoadFn *fn);
CF_API bool glApiSet(GlApi *api);

CF_API bool glApiIsSupported(U32 major, U32 minor);
CF_API void glApiToggle(GLenum cap, bool enable);
