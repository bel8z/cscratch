...
#define IM_ASSERT(_EXPR) CF_ASSERT(_EXPR, "Imgui assert")
...
//demo windows: ShowDemoWindow()/ShowStyleEditor() will be empty. Not recommended. #define
//IMGUI_DISABLE_METRICS_WINDOW                      // Disable metrics/debugger window:
...
// Requires 'stb_sprintf.h' to be available in the include path. Compatibility checks of arguments
// and formats done by clang and GCC will be disabled in order to support the extra formats provided
// by STB sprintf. #define IMGUI_USE_STB_SPRINTF
