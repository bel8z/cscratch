...
guiSetTheme(GuiTheme theme)
{
    ...
    switch (theme)
    {
        ...
        case GuiTheme_Light:
        {
            ...
            style.Colors[ImGuiCol_WindowBg]               = ImVec4{0.89f, 0.89f, 0.89f, 1.00f};
            style.Colors[ImGuiCol_ChildBg]                = ImVec4{0.00f, 0.00f, 0.00f, 0.00f};
        ...
        case GuiTheme_Dummy:
        {
            ...
            style.Colors[ImGuiCol_PopupBg]              = ImVec4{0.82f, 0.92f, 1.00f, 0.90f}; // ImVec4(0.89f, 0.98f, 1.00f, 0.99f)
